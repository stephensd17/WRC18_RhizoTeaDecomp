...
```
```{r}
ggsave("C:/Users/ohhey/OneDrive/Pictures/2018_shannon.lm.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
...
shannon
ggsave("C:/Users/ohhey/OneDrive/Pictures/2018_bacteria_shannon_diversity.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
...
ggsave("C:/Users/ohhey/OneDrive/Pictures/2018_bacteria_communitycomposition.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
...
shannon.plant <-p1 + theme_bw() + 
    ...
    scale_x_discrete(breaks=c("M", "MF"), labels=c("mowed", "mowed/fertilized"))
shannon.plant
ggsave("C:/Users/ohhey/OneDrive/Pictures/2018_plantshannon.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
# Simple Hypothesis Testing - Microbes
...
ggsave("C:/Users/ohhey/OneDrive/Pictures/2018_plant_communitycomposition.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
# CORRELATIONS Plant - FUngal
```
{r mantel test, include=FALSE}
# treatment and ditch included 

dist.plant <- vegdist(PCC.2018, method="bray")
dist.fungal <- vegdist(dataREL, method="bray")
...
plant.fungal.shannon <- cbind(design.2018, diversity.plant$shannon, diversity$shannon)

p <- ggplot(plant.fungal.shannon, aes(x=diversity.plant$shannon, y=diversity$shannon, color=treatment)) +
...
shannon.cor
ggsave("C:/Users/ohhey/OneDrive/Pictures/2018_plant_bacteria_shannondiversity.png", plot=last_plot(), device=NULL, path=NULL, scale=1, width=7, height=5, dpi=300, limitsize=TRUE)
```
